...
class Xception(nn.Module):
    ...
    def __init__(self, inplanes=3, pretrained=False):
        ...
        self.middle_blocks = nn.Sequential(
            *[Block(728, 728, reps=3, stride=1, start_with_relu=True, grow_first=True) for _ in range(16)]
        )
...
class DeepLabv3_plus(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, pretrained=False, _print=False):
